...
const Sidebar = () => {
  return (
    <div className='w-28 border-r-2 h-full border-gray-200 rounded-t-md'>
      <div className=' border-2 border-white w-24 mt-12 mb-12 rounded-sm hover:bg-gray-100 cursor-pointer p-2 sm:mb-44 sm:mt-44 ms:mt-44 ms:mb-44 md:mt-44 md:mb-44'>
        <img src={heart} alt='' className='ml-5 w-7' />
        <h1 className='text-gray-500 text-center '>CleoEMR</h1>
      </div>
      <div className=' border-2 border-white w-24 mb-12  rounded-md hover:bg-gray-100 cursor-pointer p-2 sm:mb-44 ms:mb-44 md:mb-44'>
