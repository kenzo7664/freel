...
const Sidebar = () => {
  return (
    <div className='w-28 border-r-2 h-full border-gray-200 rounded-t-md'>
      <div className=' border-2 border-white w-24 rounded-sm hover:bg-gray-100 cursor-pointer p-2'>
      ...
      <div className=' border-2 border-white w-24 rounded-md hover:bg-gray-100 cursor-pointer p-2'>
        <img src={drive} alt='' className='ml-5 w-7' />
      ...
      <div className=' border-2 border-white w-24 rounded-md hover:bg-gray-100         cursor-pointer p-2'>
        <img src={Mail} alt='' className='ml-5 w-7' />
